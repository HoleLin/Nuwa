...
public class DicomCGetFunctionalityDemo {
    ...
    public static void main(String arg[]) {
        ...
        try {
            ...
            new FindSOPClassSCU("192.168.11.216", 11112, "DCM4CHEE", "OurFindScu",
...
class OurFindHandler extends IdentifierHandler {
    ...
    private static String GetSCP_Address = "192.168.11.216";
    private static String GetSCP_AE_Title = "DCM4CHEE";
    private static int GetSCP_Port_Number = 11112;
    private static String GetSCU_AE_TITLE = "JavaClient";
    File pathToStoreIncomingDicomFiles = new File("C:\\Data\\pacs\\pixelmed\\2");
